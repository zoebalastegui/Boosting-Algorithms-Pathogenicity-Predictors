from xgboost import AdaBoostClassifier
...
for col in cols_to_clean:
    data_df.loc[data_df.ft6 == 0, col] = 0.0 # if cm_index (ft6) is 0, the value of features in cols_to_clean is 0
...
# TRAIN & TEST ---------------------------------------------------------------------------------------
model = AdaBoostClassifier(n_estimators=50, random_state=42, learning_rate=1)
...
for test_protein in unique_proteins:
    ...
    # Train the model
    model.fit(X_train, y_train) # Print messages
