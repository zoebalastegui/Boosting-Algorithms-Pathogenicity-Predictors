...
params = {'objective':'binary:logistic', 'max_depth':3, 
          'learning_rate':0.1, 'n_estimators':1000, 'silent':True, 
...
for test_protein in unique_proteins:
    ...
    model.fit(X_train, y_train,
            ...
            early_stopping_rounds=100,  # Stop training if no improvement in 'eval_metric' after 100 rounds
